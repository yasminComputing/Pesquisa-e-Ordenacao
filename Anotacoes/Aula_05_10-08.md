...
- ListaController
    ...
    - popularListaBolha --- 5.000
    - popularListaSelecao --- 5.000
    - popularListaInsercao --- 5.000

(isso aqui está dentro da classe que está os metódos)
    ?.bolha(listaBolha)
    ?.selecao(listaSelecao)
    ?.insercao(listaInsercao)

> a pergunta é onde vai ficar a classe que chama esses metódos.