# Aula 04 - Dia 06.08.2026

Premissas das Disciplinas
...
* Benchmark
  * Medições: `COMPLEXIDADE` -> Qtde de comparações e qtde de trocas | `Tempo`


# Medir Tempo de Ordenação
Exemplos retirado do repositório da `disciplina`. 
